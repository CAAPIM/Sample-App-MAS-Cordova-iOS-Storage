...
2. This app depends upon the MAS iOS Native dependencies 1.8.00 pulled, which have been already ingested into the build file i.e. you don't need to make any change in build configurations. Just open the app in XCode, build and run.
